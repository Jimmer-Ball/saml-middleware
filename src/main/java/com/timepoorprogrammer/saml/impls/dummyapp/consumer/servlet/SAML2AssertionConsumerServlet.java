...
/**
 * SAML2 assertion consumer for DummyApp used in commissioning.
 *
 * @author Jim Ball
 */
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (redirectionDetails.sessionCreated()) {
                ...
                final String errorDetails = String.format(AuditMessages.ConsumerCode.CONSUMER_CONTENT_ERROR.getDetailsPattern(),
