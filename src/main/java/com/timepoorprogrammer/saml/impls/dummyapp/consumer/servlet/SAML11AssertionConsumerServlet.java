package com.timepoorprogrammer.saml.impls.dummyapp.consumer.servlet;
...
/**
 * SAML1.1 assertion consumer for DummyApp used in commissioning. Note SAML1.1 does not transport encrypted assertions.
 *
 * @author Jim Ball
 */
public class SAML11AssertionConsumerServlet extends HttpServlet {
    private static final long serialVersionUID = -4164844922813590945L;
     ...
     */
    private static final String ASSERTION_CONSUMER_NAME = "DummyApp";
        ...
        try {
            ...
            if (gotAssertion != null) {
                ...
                if (issuer != null) {
                    ...
                    // Now redirect appropriately (we need to manage sessions and cookies properly)
