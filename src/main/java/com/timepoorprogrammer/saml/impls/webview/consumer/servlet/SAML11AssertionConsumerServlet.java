...
/**
 * SAML1.1 assertion consumer for WebView (Aurora). Note SAML1.1 does not transport encrypted assertions.
 *
 * @author Jim Ball
 */
public class SAML11AssertionConsumerServlet extends HttpServlet {
    private static final long serialVersionUID = 658412125352105637L;
    /**
     * Logging handle
     */
        ...
        try {
            ...
            if (gotAssertion != null) {
                ...
                if (issuer != null) {
                    ...
                    final String userIdentifier = gotAssertion.getAuthenticationStatements().get(0).getSubject().getNameIdentifier().getNameIdentifier().toUpperCase();
