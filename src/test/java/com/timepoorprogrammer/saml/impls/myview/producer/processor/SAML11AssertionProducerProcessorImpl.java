...
/**
 * Bespoke SAML 1.1 assertion producer processor.
 *
 * @author Jim Ball
 */
public class SAML11AssertionProducerProcessorImpl extends com.timepoorprogrammer.saml.impls.standard.producer.processor.SAML11AssertionProducerProcessorImpl
        implements SAML11AssertionProducerProcessor {
    private static final Logger log = LoggerFactory.getLogger(SAML11AssertionProducerProcessorImpl.class);
     ...
     * @param serviceCode                 service provider or partner Northgate internal code
    ...
    public SAML11AssertionProducerProcessorImpl(final String metaDataFilePath,
        ...
        log.info("Bespoke SAML1.1 assertion producer processor for destination SP MyView");
    }
}
